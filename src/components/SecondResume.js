...
import styles from "./SecondResume.module.css"
import React, { forwardRef, useEffect, useRef, useState } from "react";
import ReactToPrint from "react-to-print";

const SecondResume = forwardRef((props, ref) => {
    ...
    const sectionDiv = {
        ...
        [sections.project]: (
            ...
            >
                <div className={styles.sectionTitle}>
                    <h1> {info.project.sectionTitle}</h1>
                </div>
        ...
        [sections.education]: (
            ...
            >
                <h1> {info.education?.sectionTitle}</h1>
                <div className={`${styles.sectionDetails}`} >
            ...
            <div  className={styles.secondResumeContainer} ref={containerRef}>
                ...
                {/* <div className={styles.section}>
                        ...
                        <div className={styles.sectionDetails}>
                            ...
                            <div>
                                <p >This is a resume builder application praesentium reiciendis fuga voluptatem itaque nisi.</p>
                            </div>
                ...
                {/* 
                    <div className={`section ${styles.workExperience}`}>
                        <h1 className={styles.border}>Work Experience</h1>

                        <div className={styles.sectionDetails}>
                            <h4>Work Experience title</h4>
                            <p className={styles.highlight}>Company Name</p>
                            <a className={styles.link} href={"#"}>
                                <Paperclip />
                                {"Certificate"}
                            </a>
                            ...
                            <p className={`${styles.date} ${styles.link}`}>
                                <MapPin />"location"
                            </p>
                ...
                {/* <div className={`section ${styles.education}`}>
                        <h1 className={styles.border}>Education</h1>
                ...
                {/* <div className={`section ${styles.achievements}`}>
                        

                        <div className={styles.projectDesc}>
                            <h1 className={styles.border}>Achievements</h1>
                            <ol>
                                <li>first desc</li>
                                <li>second desc</li>
                                <li>third desc</li>
                ...
                {/* <div className={`section ${styles.summary}`}>
                        <h1 className={styles.border}>Summary</h1>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. In assumenda culpa quae. Fugiat nihil nobis, ex reiciendis, tempora enim exercitationem voluptate in nulla accusamus magnam tenetur quas culpa dignissimos aut, et excepturi libero temporibus earum cupiditate asperiores sunt eos quos.</p>
                    </div>

                    <div className={`section ${styles.others}`}>
                        <h1 className={styles.border}>Others</h1>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. In assumenda culpa quae. Fugiat nihil nobis, ex reiciendis, tempora enim exercitationem voluptate in nulla accusamus magnam tenetur quas culpa dignissimos aut, et excepturi libero temporibus earum cupiditate asperiores sunt eos quos.</p>
                    </div> */}
                {/* </div> */}
